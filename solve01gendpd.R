...
solve01gendpdrt=function(smp,beta){
  ...
  valuesort=sort(valuef)
  index=which(valuef==valuesort[1])
  sol0.2=gendpdrt(smp,0.2,beta,st[[index]][1:2])
  for(j in 2:10){
  ...
  valuesort=sort(valuef)
  index=which(valuef==valuesort[1])
  sol0.4=gendpdrt(smp,0.4,beta,st[[index]][1:2])
  for(j in 2:10){
  ...
  valuesort=sort(valuef)
  index=which(valuef==valuesort[1])
  sol0.6=gendpdrt(smp,0.6,beta,st[[index]][1:2])
  for(j in 2:10){
  ...
  valuesort=sort(valuef)
  index=which(valuef==valuesort[1])
  sol0.8=gendpdrt(smp,0.8,beta,st[[index]][1:2])
  for(j in 2:10){
  ...
  valuesort=sort(valuef)
  index=which(valuef==valuesort[1])
  sol1=gendpdrt(smp,1,beta,st[[index]][1:2])
  for(j in 2:10){
